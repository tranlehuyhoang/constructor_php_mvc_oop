...
<body>
    ...
    <div class="flex-container">
        ...
        <div><img src="<?php echo ASSETS_URL_ROOT . '/public/imgs/' . $p_assoc['image'] ?>" alt="" srcset="">
            <div>
                <a href="<?php echo ASSETS_URL_ROOT . '/products/productdetail/' . $p_assoc['id'] ?>">
    ...
    <div class="flex-container1">
        ...
        if (isset($p_view)) {
            ...
            while ($p_assoc = $p_view->fetch_assoc()) {
                if ($count == 0) {
        ?>
        <div><img style="width: 100%; height: 90%;"
                src="<?php echo ASSETS_URL_ROOT . '/public/imgs/' . $p_assoc['image'] ?>" alt="" srcset="">
            <div>
                <a href="<?php echo ASSETS_URL_ROOT . '/products/productdetail/' . $p_assoc['id'] ?>">
                    <div>name: <?php echo $p_assoc['name'] ?></div>
                </a>
        ...
        <div>
            ...
            if (isset($p_views)) {
                ...
                while ($p_assoc = $p_views->fetch_assoc()) {
                    if ($count > 0) {
            ?>
            <div><img style="width: 100%; height: 80%;"
                    src="<?php echo ASSETS_URL_ROOT . '/public/imgs/' . $p_assoc['image'] ?>" alt="" srcset="">
                <div>
                    <a href="<?php echo ASSETS_URL_ROOT . '/products/productdetail/' . $p_assoc['id'] ?>">
                        <div>name: <?php echo $p_assoc['name'] ?></div>
    ...
    <div class="flex-container2">
        <div class="container2_div1">
            ...
            ?>
            <div
                style=" display: flex; background-image: url(<?php echo ASSETS_URL_ROOT . '/public/imgs/' . $p_assoc['image'] ?>); background-size: cover; background-repeat: no-repeat ; background-position: center; ">
                <div>
                    <a href="<?php echo ASSETS_URL_ROOT . '/products/productdetail/' . $p_assoc['id'] ?>">
                        <div>name: <?php echo $p_assoc['name'] ?></div>
                    </a>
            ...
            <div>
                ...
                ?>
                <div
                    style="background-image: url(<?php echo ASSETS_URL_ROOT . '/public/imgs/' . $p_assoc['image'] ?>); background-size: cover; background-repeat: no-repeat ; background-position: center; ">
                    <div>
                        <a href="<?php echo ASSETS_URL_ROOT . '/products/productdetail/' . $p_assoc['id'] ?>">
                            <div>name: <?php echo $p_assoc['name'] ?></div>
                        </a>
